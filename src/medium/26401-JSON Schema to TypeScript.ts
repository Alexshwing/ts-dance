...
type HandleObject<T extends Record<string, any>> = T extends {
...
type HandleArray<T extends Record<string, any>> = T extends {
  items: infer Items
}
  ? JSONSchema2TS<Items>[]
  : unknown[]

type JSONSchema2TS<T extends Record<string, any>> = T extends {
  type: infer Type
}
  ? Type extends keyof Primitive
